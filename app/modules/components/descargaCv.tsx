...
const DescargaCv = () => {
  return (
    <>
      <section className=" text-white body-font  animate__animated animate__fadeIn animate__delay-900ms animate__slower">
        <div className="  bg-[url('/assets/yo.png')] bg-cover bg-center bg-no-repeat container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <div className="md:pt-20 text-center lg:w-2/3 w-full">
            <div className="avatar mb-10">
              <div className="w-40 h-40 xs:w-20 xs:h-20 rounded-full flex flex-wrap ring mt-10 ring-cyan-600 ring-offset-black ring-offset-4">
            ...
            <p className=" text-xl mb-4 mt-4 leading-relaxed">Desarrollador Front-end.</p>
