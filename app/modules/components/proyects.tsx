  ...
  return (
    <>
      ...
      { dataProjects.map((item, index) => ( 
        ...
        <div className={`py-8 mb-26 rounded-lg ${item.bg} backdrop-blur-3xl   border border-zinc-600 hover:border hover:border-cyan-700 font-medium  container mx-auto flex md:flex-row flex-col items-center`}>
