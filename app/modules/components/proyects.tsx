    ...
    <>
      <section id='proyectos' className=" text-gray-600 body-font animate__animated animate__fadeIn animate__delay-900ms animate__slower">
        <div className="container px-5 pt-10 py-6 mx-auto">
          <h1 className="pt-8 bg-gradient-to-r backdrop-blur-2xl  text-xl  sm:text-xl-medium  pb-2 from-gray-100 via-gray-400 to-gray-600 bg-clip-text font-extrabold text-transparent " style={{ textShadow: '2px 3px 4px rgba(255, 255, 255, 0.5)' }}>
          Algunos de mis  proyectos
            </h1>
          <div className='text-start mb-10  max-w-sm border border-white'></div>
          <div className="flex flex-wrap -m-4">
            {dataProjects.map((item) => (
              <div key={item.title} className="scrollCard p-4 md:w-1/3 group">
                <div className="h-full border-2 border-gray-600 hover:border-gray-300 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div className="p-6 bg-gray-950">
                    <h1 className=" text-xl text-gray-300 group-hover:text-cyan-700 mb-3">{item.title}</h1>
