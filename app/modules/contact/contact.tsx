...
const Contacto = () => {
      const { formData, handleInputChange, handleSubmit, isOk, handleClick, loading } = useFormPost()
                                    ...
                                    <div className=" max-w-screen-xl  py-2  ">
                                          <div className=" text-start grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
                                                ...
                                                <div className=" lg:col-span-3 ">
                                                      ...
                                                      <form onSubmit={handleSubmit} method='POST' className="space-y-4 rounded-lg  bg-white py-8 px-6 shadow-lg">
                                                            <div>
                                                            ...
                                                            <div className="mt-4">
                                                                  {formData.email && formData.name &&  formData.message ? ( 
                                                                        ...
                                                                        <button
                                                                              type="submit"
                                                                              onClick={handleClick}
                                                                              className="flex  animate__animated animate__fadeIn animate__delay-600ms animate__slower justify-center gap-2 items-center mx-auto shadow-xl text-lg  backdrop-blur-md lg:font-semibold isolation-auto border-gray-200 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full bg-cyan-600 text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
                                                                        >
                                                                              Enviar
                                                                              {loading ? (
                                                                                    <>
                                                                                    ...
                                                                                    <svg
                                                                                          className="w-8 h-8 justify-end group-hover:rotate-90 bg-gray-50 text-gray-50 ease-linear duration-300 rounded-full border border-gray-400 group-hover:border-none p-2 rotate-45"
                                                                                          viewBox="0 0 16 19"
